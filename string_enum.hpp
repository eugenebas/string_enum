...
#define __STR_ENUM_STRING_ARRAY_START(enum_name, ...) constexpr std::array<const char*, __STR_ENUM_COUNT_ARGS(__VA_ARGS__) > __STR_ENUM__INNER_ARRAY_NAME(enum_name) {
#define __STR_ENUM_STRING_ARRAY_END(enum_name) }; // __STR_ENUM_STRING_ARRAY_START(enum_name)

#define __STR_ENUM_STRING_ARRAY(enum_name, ...)\
    __STR_ENUM_STRING_ARRAY_START(enum_name, __VA_ARGS__)\
    __STR_ENUM_GENERATE_STRINGS(__VA_ARGS__)\
    __STR_ENUM_STRING_ARRAY_END(enum_name)\
...
struct __STR_ENUM__BASE_STRING_ENUM_NAME(enum_name) { \
    ...
    static __STR_ENUM_STRING_ARRAY(enum_name, __VA_ARGS__)\
    \
